...
**Scope id:** `app:inventory` · **Owns:** `apps/inventory/**` · **Port:** 3003
...
```sh
pnpm --filter inventory dev    # port 3003, fixture session, no peers needed
```

## Rules

- Keep changes inside `apps/inventory/**`. App-specific styles go in this
